...
function get_collection($ref)
	...
	$return=sql_query("select c.*,c.theme2,c.theme3,c.keywords,u.fullname,u.username,c.home_page_publish,home_page_text,home_page_image from collection c left outer join user u on u.ref=c.user where c.ref='$ref'");
